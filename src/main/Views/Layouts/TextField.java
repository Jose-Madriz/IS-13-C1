...
public class TextField extends Element{
    ...
    // Constructor
    // Constructor
    public TextField( float relWidth, float relHeight, float posPercentX, float posPercentY, boolean visibility, String content, Window father ){
        super( relWidth, relHeight, posPercentX, posPercentY, visibility );
        this.content = content;
        this.father = father;
    }
    public TextField( float relWidth, float relHeight, String content, Window father ){
        super( relWidth, relHeight );
        this.content = content;
        this.father = father;
    }
    public TextField( float relWidth, float relHeight, Window father){
        super( relWidth, relHeight );
        this.content = "DefaultContent";
        this.father = father;
    }
    public TextField( Window father ){
        super( );
        this.content = "DefaultContent";
        this.father = father;
    }
