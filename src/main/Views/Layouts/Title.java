...
public class Title extends Element{
    ...
    public Title( float relWidth, float relHeight, String content, Window father ){
        super( relWidth, relHeight );
        this.content = content;
        this.father = father;
    }
    public Title( float relWidth, float relHeight, Window father){
        super( relWidth, relHeight );
        this.content = "DefaultContent";
        this.father = father;
    }
    public Title( Window father ){
        super( );
        this.content = "DefaultContent";
        this.father = father;
    }
